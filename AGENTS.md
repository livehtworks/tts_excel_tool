...
- Desktop and native voice probes use a UTF-8 process manifest for third-party resource paths (Windows 10 1903 or newer). Unicode espeak path verification must start in a fresh process before any ASCII model is loaded.
